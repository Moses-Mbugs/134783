...
$sql = "SELECT u.first_name, u.last_name, u.email, u.profession, ud.age, ud.location, ud.gender, ud.bio, ud.profile_photo, ud.linkedin_link, ud.github_link
        FROM users u
...
<body>
    ...
    <div class="centered-content">
        ...
        <div class="text">
            ...
            <p>Linkedin:  <?php echo $linkedin_link ;?></p>
